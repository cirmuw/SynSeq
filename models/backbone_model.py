...
class SyntaxLightningModule(pl.LightningModule):
    def __init__(
        ...
        save_path: str = None,
        loss_fn: str = "BCEWithLogitsLoss", # Currently unused
    ...
    def test_step(self, batch: Any, batch_idx: int, dataloader_idx: int = 0) -> Any:
        ...
        output = {"y": y.cpu().tolist()[0][0], "y_pred": torch.round(y_pred).cpu().tolist()[0][0],
                  "y_prob": y_pred.cpu().tolist()[0][0], "path": path[0]}
